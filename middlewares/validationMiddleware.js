...
const validationMiddleware = [
  check("username").notEmpty().withMessage("Debes completar este campo"),
  ...
  check("email").notEmpty().withMessage("Debes completar este campo").bail().isEmail().withMessage("Direccion de correo invalida"),
