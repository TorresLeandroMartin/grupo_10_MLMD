...
const validateProduct = [
    body("estilo").isLength({ min: 4, max: 30 }).withMessage("Tenés que elgir el estilo del producto"),
    body("nombre").isLength({ min: 4, max: 30 }).withMessage("El nombre del producto debe tener al menos 4 letras"),
